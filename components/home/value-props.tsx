...
const valueProps = [
  {
    ...
    description: 'מטפל רגשי מוסמך עם ניסיון של 20 שנה בעבודה עם אנשים עם צרכים מיוחדים בשלל מסגרות. מיישם גישה קשובה וסבלנית במטרה לעזור למשתתים לצבור ביטחון וסקרנות.',
  },
  {
    icon: Cpu,
