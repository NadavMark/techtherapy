...
const tools: Tool[] = [
  ...
  { name: 'Camera', icon: 'mdi:camera', color: '#4285F4' },
...
{ name: 'Google Docs', icon: 'simple-icons:googledocs', color: '#4285F4' },
  ...
  { name: 'Instagram', image: '/Instagram_icon.png' },
  ...
  { name: 'Google Lens', image: '/Google_Lens_Icon.png'}, 
...
export function ToolboxSection() {
  ...
  return (
    <SectionWrapper className="bg-gray-50 py-12">
      ...
      <div className="grid grid-cols-4 sm:grid-cols-5 md:grid-cols-6 lg:grid-cols-8 xl:grid-cols-10 gap-3items-center justify-items-center">
        {tools.map((tool, index) => {
          return (
            <AnimatedWrapper key={tool.name} delay={index * 0.02}>
              <div
                className="group relative flex flex-col items-center justify-center rounded-xl transition-all hover:bg-white hover:shadow-sm hover:scale-105 cursor-pointer w-20 h-20"
              ...
              >
                {tool.image ? (
                  <Image
                    ...
                    width={40}
                    height={40}
                    className="h-12 w-12 object-contain drop-shadow-sm transition-all group-hover:drop-shadow-md"
                  />
                ) : (
                  <Icon
                    icon={tool.icon!}
                    className="h-12 w-12 drop-shadow-sm transition-all group-hover:drop-shadow-md"
